...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://github.com/SkonJIYHD', label: 'GitHub' },
    { link: 'https://blog.sikon.top/', label: '博客' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: 'UptimeKuma',
      method: 'HEAD',
      target: 'https://uptime.sikon.top/',
      statusPageLink: 'https://uptime.sikon.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '博客入口',
      method: 'HEAD',
      target: 'https://blog.sikon.top/',
      statusPageLink: 'https://blog.sikon.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '邮箱',
      method: 'HEAD',
      target: 'https://moemail.sikon.top/',
      timeout: 5000,
    },
    {
      id: 'Server',
  ...
  notification: {
    ...
    webhook: {
      ...
      payload: {
        "from": "系统状态更新 <uptimeflare@update.sikon.top>",
        "to": ["2661028830@qq.com"],
